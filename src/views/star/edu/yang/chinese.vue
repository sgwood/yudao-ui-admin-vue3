<template>
  <ContentWrap>
    <div @click="toProfile" class="mt-12">语文</div>
    <div @click="toProfile" class="mt-12">数学</div>
    <div @click="toProfile" class="mt-12 mb-15 cursor-wait">英语</div>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['star:edu-plan:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['star:edu-plan:export']"
        >
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['star:edu-plan:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['star:edu-plan:delete']"
          >
            删除
          </el-button>
        </template>
